...
public class ServerQuery implements Serializable {
	...
	public String execute(String command, StringMap parameters, String[] options) throws ServerQueryError {
	...
	public ServerQueryResponse query(String command, StringMap parameters, String[] options) throws ServerQueryError {
